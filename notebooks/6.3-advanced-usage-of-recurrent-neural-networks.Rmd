...
fname <- file.path(data_dir, "jena_climate_2009_2016.csv.gz")
data <- read_csv(fname)
```
...
# Each epoch is ~50sec, full training is ~16min, same on GPU
...
```{r}
save_model_hdf5(model, "data/jena_climate_1.h5")
load_model_hdf5("data/jena_climate_1.h5")
save(list = c("history"), file = "data/jena_climate_history_1.rdata")
load(file = "data/jena_climate_history_1.rdata")
```
...
# Each epoch takes ~160sec, full training <1hour
# GPU, each epoch takes ~16min, total time 5 hours
history <- model %>% fit_generator(
  train_gen,
  steps_per_epoch = 500,
  epochs = 20,
...
```{r}
save_model_hdf5(model, "data/jena_climate_2.h5")
load_model_hdf5("data/jena_climate_2.h5")
save(list = c("history"), file = "data/jena_climate_history_2.rdata")
load(file = "data/jena_climate_history_2.rdata")
```
...
# Each epoch is ~170sec, total time <2 hours
history <- model %>% fit_generator(
  train_gen,
  steps_per_epoch = 500,
  epochs = 40,
...
```{r}
save_model_hdf5(model, "data/jena_climate_3.h5")
load_model_hdf5("data/jena_climate_3.h5")
save(list = c("history"), file = "data/jena_climate_history_3.rdata")
load(file = "data/jena_climate_history_3.rdata")
```
...
# Each epoch takes ~360sec, total training ~4 hours
history <- model %>% fit_generator(
  train_gen,
  steps_per_epoch = 500,
  epochs = 40,
...
```{r}
save_model_hdf5(model, "data/jena_climate_4.h5")
load_model_hdf5("data/jena_climate_4.h5")
save(list = c("history"), file = "data/jena_climate_4_history.rdata")
load(file = "data/jena_climate_4_history.rdata")
```
...
# Each epoch is ~15min, total time ~5 hours
history <- model %>% fit_generator(
  train_gen_reverse,
  steps_per_epoch = 500,
  epochs = 20,
...
```{r}
save_model_hdf5(model, "data/jena_climate_5.h5")
load_model_hdf5("data/jena_climate_5.h5")
save(list = c("history"), file = "data/jena_climate_5_history.rdata")
load(file = "data/jena_climate_5_history.rdata")
```
...
# Could not run, OverflowError: Python int too large to convert to C long
# Run on GPU, each epoch is ~3min, total time ~30min
history <- model %>% fit(
  x_train, y_train,
  epochs = 10,
  batch_size = 128,
...
```{r}
save_model_hdf5(model, "data/6_3_advanced_RNN_1.h5")
load_model_hdf5("data/6_3_advanced_RNN_1.h5")
save(list = c("history"), file = "data/6_3_advanced_RNN_history_1.rdata")
load(file = "data/6_3_advanced_RNN_history_1.rdata")
```
...
# Could not run: OverflowError: Python int too large to convert to C long
# Run on GPU, each epoch is ~5min, total time ~45min
history <- model %>% fit(
  x_train, y_train,
  epochs = 10,
  batch_size = 128,
...
```{r}
save_model_hdf5(model, "data/6_3_advanced_RNN_2.h5")
load_model_hdf5("data/6_3_advanced_RNN_2.h5")
save(list = c("history"), file = "data/6_3_advanced_RNN_history_2.rdata")
load(file = "data/6_3_advanced_RNN_history_2.rdata")
```
...
# Each epoch takes ~30min, total time 
history <- model %>% fit_generator(
  train_gen,
  steps_per_epoch = 500,
  epochs = 40,
...
```{r}
save_model_hdf5(model, "data/jena_climate_6.h5")
load_model_hdf5("data/jena_climate_6.h5")
save(list = c("history"), file = "data/jena_climate_6_history.rdata")
load(file = "data/jena_climate_6_history.rdata")
```
