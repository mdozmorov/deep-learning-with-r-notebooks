...
# Each eposh is ~40sec, total time ~8min
history <- model %>% fit(
  x_train, y_train,
  epochs = 10,
  batch_size = 128,
...
```{r}
save_model_hdf5(model, "data/6_4_1Dconvnet_1.h5")
load_model_hdf5("data/6_4_1Dconvnet_1.h5")
save(list = c("history"), file = "data/6_4_1Dconvnet_history_1.rdata")
load(file = "data/6_4_1Dconvnet_history_1.rdata")
```
...
# Each epoch takes ~110sec, total time ~30 min
...
```{r}
save_model_hdf5(model, "data/6_4_1Dconvnet_2.h5")
load_model_hdf5("data/6_4_1Dconvnet_2.h5")
save(list = c("history"), file = "data/6_4_1Dconvnet_history_2.rdata")
load(file = "data/6_4_1Dconvnet_history_2.rdata")
```
...
# Each epoch is ~10min, total time ~3 hours
history <- model %>% fit_generator(
  train_gen,
  steps_per_epoch = 500,
  epochs = 20,
...
```{r}
save_model_hdf5(model, "data/6_4_1Dconvnet_3.h5")
load_model_hdf5("data/6_4_1Dconvnet_3.h5")
save(list = c("history"), file = "data/6_4_1Dconvnet_history_3.rdata")
load(file = "data/6_4_1Dconvnet_history_3.rdata")
```
